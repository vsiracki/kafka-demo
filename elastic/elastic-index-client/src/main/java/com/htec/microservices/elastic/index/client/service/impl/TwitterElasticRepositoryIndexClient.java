package com.htec.microservices.elastic.index.client.service.impl;

import com.htec.microservices.elastic.index.client.repository.TwitterElasticsearchIndexRepository;
...
public class TwitterElasticRepositoryIndexClient implements ElasticIndexClient<TwitterIndexModel> {
    ...
    TwitterElasticRepositoryIndexClient(TwitterElasticsearchIndexRepository indexRepository) {
