...
import com.htec.microservices.config.ElasticQueryConfigData;
...
import com.htec.microservices.elastic.query.client.util.ElasticQueryUtil;
...
public class TwitterElasticQueryClient implements ElasticQueryClient<TwitterIndexModel> {
    ...
    TwitterElasticQueryClient(ElasticConfigData configData,
