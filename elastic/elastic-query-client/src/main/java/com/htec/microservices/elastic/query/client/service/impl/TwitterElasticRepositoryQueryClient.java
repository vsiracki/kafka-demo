package com.htec.microservices.elastic.query.client.service.impl;

import com.htec.microservices.common.util.CollectionsUtil;
import com.htec.microservices.elastic.model.index.impl.TwitterIndexModel;
import com.htec.microservices.elastic.query.client.exception.ElasticQueryClientException;
import com.htec.microservices.elastic.query.client.repository.TwitterElasticsearchQueryRepository;
...
public class TwitterElasticRepositoryQueryClient implements ElasticQueryClient<TwitterIndexModel> {
    ...
    TwitterElasticRepositoryQueryClient(TwitterElasticsearchQueryRepository repository) {
